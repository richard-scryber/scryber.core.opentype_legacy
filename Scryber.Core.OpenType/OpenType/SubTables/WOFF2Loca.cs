...
{
    public class GlyphLocations : TTFTable
    {
        ...
        uint[] _offsets;
        public GlyphLocations(long offset, int glyphCount, bool isLongVersion)
            : base(offset)
        {
        ...
        protected void ReadContentFrom(BigEndianReader reader)
        {
            //Short version
